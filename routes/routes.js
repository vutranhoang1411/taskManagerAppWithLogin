...
const {getHomePage,getRegister,getLogin,userLogin,userRegister, getTasks,postTasks, getOneTask, postOneTask} = require('../controllers/controllers')
...
routes.route('/tasks/:id').all(authentication).get(getOneTask).post(postOneTask);
